 ...
 * @version $Revision: 1.1 $, $Date: 2007-01-28 00:07:51 +0100 (dim., 28
 *          janv. 2007) $
 */
...
public class CompressionServletResponseWrapper extends
	...
	if (debug > 1) {
	    System.out
		    .println("CompressionServletResponseWrapper constructor gets called");
	}
    }
    ...
    /**
         * The PrintWriter that has been returned by <code>getWriter()</code>,
         * if any.
         */
	...
	if (debug > 1) {
	    System.out
		    .println("flush buffer @ CompressionServletResponseWrapper");
	}
    ...
    /**
         ...
         *                    if <code>getWriter</code> has already been
