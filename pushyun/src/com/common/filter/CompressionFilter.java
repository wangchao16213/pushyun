 ...
 * @version $Revision: 1.1 $, $Date: 2006-10-24 05:14:34 +0200 (mar., 24 oct.
 *          2006) $
 */
...
public class CompressionFilter implements Filter {
    ...
    /**
         ...
         * The FilterChain passed into this method allows the Filter to pass on
         ...
         * It simply just pass the request and response if there is no support
         * for compression.<br>
         * If the compression support is available, it creates a
         * CompressionServletResponseWrapper object which compresses the content
         * and modifies the header if the content length is big enough. It then
         * invokes the next entity in the chain using the FilterChain object (<code>chain.doFilter()</code>),
         * <br>
         */
	...
	if (request instanceof HttpServletRequest) {
	    ...
	    String s = (String) ((HttpServletRequest) request)
		    .getParameter("gzip");
	    if ("false".equals(s)) {
		if (debug > 0) {
		    System.out
