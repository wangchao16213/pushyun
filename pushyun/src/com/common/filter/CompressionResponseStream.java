...
public class CompressionResponseStream extends ServletOutputStream {
    ...
    /**
         ...
         * starting at the specified offset, to our output stream.
         * 
         * @param b
         *                The byte array containing the bytes to be written
         * @param off
         *                Zero-relative starting offset of the bytes to be
         *                written
         * @param len
	...
	if (gzipstream == null) {
		...
		if (debug > 1)
		    System.out
			    .print("Response already committed. Using original output stream");
		gzipstream = output;
	    } else {
