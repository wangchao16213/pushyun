...
<div class="bjui-pageContent">
        <form action="<%=path%>/module/business/dns?action=modify" data-alertmsg="false" class="datagrid-edit-form" data-toggle="validate" data-data-type="json"> 
        <input type="hidden" name="id" value="${businessDnsForm.id}" >
